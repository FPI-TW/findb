...
class MarketDataEOD(Base):
    ...
    up_volume: Mapped[Optional[int]] = mapped_column(BigInteger, nullable=True)
    down_volume: Mapped[Optional[int]] = mapped_column(BigInteger, nullable=True)
    up_ticks: Mapped[Optional[int]] = mapped_column(BigInteger, nullable=True)
    down_ticks: Mapped[Optional[int]] = mapped_column(BigInteger, nullable=True)
