...
- [ ] 依[staging AWS deployment plan](staging-aws-deployment-plan.md)執行FinDB Phase 4 live exit gates（兩次
  SSM deployment、rollback rehearsal與另行授權的SSH secret移除），並完成Fetcher Phase 5 SSM日常deployment
  transport與相應演練。
