...
echo "       EC2_SSH_KEY"
echo "       DATABASE_URL"
echo "       SOURCE_API_KEYS"
echo "       ADMIN_API_KEYS"
echo "       SERVE_API_KEYS (required when SERVE_REQUIRE_AUTH=true)"
echo "       FINDB_SERVE_API_KEY (required when SERVE_REQUIRE_AUTH=true)"
echo "     Variables:"
echo "       APP_NAME, APP_VERSION, DEBUG, PORT"
echo "       DATABASE_POOL_SIZE, DATABASE_MAX_OVERFLOW"
echo "       API_V1_PREFIX, API_KEY_HEADER"
echo "       SOURCE_ALLOWLIST_CIDRS, SOURCE_TRUST_PROXY_HEADERS"
echo "       SERVE_REQUIRE_AUTH"
echo "       RATE_LIMIT_REQUESTS, RATE_LIMIT_WINDOW"
echo "       RAW_RETENTION_ENABLED, RAW_RETENTION_DAYS"
echo "       FINDB_BASE_URL, FINDB_LATEST_PRICE_WORKERS"
echo ""
