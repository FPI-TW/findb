...
class CryptoIndexNormalizer(BaseNormalizer):
    """
    Normalizer for crypto index market data.
    """
    ...
    def map_fields(self, raw_data: dict) -> list[MappedRecord]:
        """
        Map crypto index data to canonical format.
        """
