...
BASE_URL = (os.getenv("FINDB_STATIC_CACHE_BASE_URL") or "http://localhost:8080").rstrip("/")
...
OUTPUT_PATH = BACKEND_ROOT / "app" / "static" / "data" / "instruments.json"
MACRO_OUTPUT_PATH = BACKEND_ROOT / "app" / "static" / "data" / "macro-series.json"
