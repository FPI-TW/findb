...
TARGET_TABLES = (
    ...
    "public.tw_minute_archive_chunk",
    "public.tw_minute_archive_release",
    "public.tw_minute_daily_update",
    "public.tw_minute_dataset_snapshot",
    "public.tw_minute_publication_revision",
    "public.tw_minute_snapshot_part",
    "public.tw_minute_universe_member",
    "public.tw_minute_universe_release",
    "raw.market_payload",
)
