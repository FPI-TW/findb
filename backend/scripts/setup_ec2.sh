...
echo "       SOURCE_API_KEY (optional legacy fallback)"
echo "       ADMIN_API_KEY (optional legacy fallback)"
echo "       SERVE_API_KEYS (optional legacy fallback; DB-backed keys preferred)"
